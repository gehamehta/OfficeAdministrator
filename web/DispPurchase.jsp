<%-- 
    Document   : DispPurchase
    Created on : 24 Jun, 2015, 12:30:13 PM
    Author     : Rachna
--%>
...
<html>
    ...
    <body>
        ...
        <br><b>Purchase Details:&nbsp;</b> &nbsp;&nbsp; <b><%=df.format(frm)%></b>
        ...
        <table>
            ...
            <% while(fromDate.compareTo(toDate)<=0){
                    %>&nbsp;&nbsp;
                    <%
                   String query="select DATE_FORMAT(Date,'%b %d') as Date,Time,BillNo,Name,Quantity,Amount,PaymentMode,PaymentStatus from itemspurchased where Date='"+fromDate+"' order by date asc,time asc " ;
