<%-- 
    Document   : DispEnquiry
    Created on : 24 Jun, 2015, 1:44:01 PM
    Author     : Rachna
--%>
...
<html>
    ...
    <body>
        ...
        <div id="printenquiry">
        <br><b>Enquiry Details:&nbsp;</b> &nbsp;&nbsp; <b><%=df.format(frm)%></b>
        ...
        <table>
            ...
            <% while(fromDate.compareTo(toDate)<=0){
                    %>&nbsp;&nbsp;
                    <%
                   String query="select DATE_FORMAT(Date,'%b %d') as Date,ID,EnquiryFrom,EnquiryMode,EnquiryMsg,EnquiryTime,Response,Quotation,ResponseTime,Status,FollowUp from marketing where Date='"+fromDate+"' order by date asc,EnquiryTime asc " ;
