<%-- 
    Document   : EditSales
    Created on : 15 Jun, 2015, 2:02:34 PM
    Author     : Rachna
--%>
...
<html>
    ...
    <body>
        <%
         ...
         String query="select Name,Quantity,Amount,PaymentMode,PaymentStatus from itemssold where BillNo='"+billno+"'";
         ...
         <table>
             ...
             <tr>
                 <td>Payment Mode: </td> 
                 <td><select name="paymentmode" value="<%=mode%>" style="width:200px">
             ...
             <tr>
                 ...
                 <td><select name="status" value="<%=status%>" style="width:200px">
        ...
        <form action="DeleteSales" method="post">
             <input type="hidden" name="billno" value="<%=billno%>">
