<%-- 
    Document   : DispSales
    Created on : 24 Jun, 2015, 12:33:36 PM
    Author     : Rachna
--%>
...
<html>
    ...
    <body>
        ...
        <div id="printsales">
        <br><b>Sales Details:&nbsp;</b> &nbsp;&nbsp; <b><%=df.format(frm)%></b>
        ...
        <table>
            ...
            <% while(fromDate.compareTo(toDate)<=0){
                    %>&nbsp;&nbsp;
                    <%
                   String query="select DATE_FORMAT(Date,'%b %d') as Date,Time,BillNo,Name,Quantity,Amount,PaymentMode,PaymentStatus from itemssold where Date='"+fromDate+"' order by date asc,time asc " ;
