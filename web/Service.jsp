<%-- 
    Document   : Service
    Created on : 10 Jun, 2015, 12:27:35 PM
    Author     : Rachna
--%>
...
%>
       ...
       <div  style="text-align: left; font-size: 20px; float: left; width: 50%; font-family: serif;"><b>Welcome <%=name%></b></div>
        ...
        <h1 style=" text-align:center; font-family:sans serif;">Service</h1><hr/>
        
        <br>
         <div style="width: 100%; margin: 0 auto ; padding: 30px 0 40px;">
        <ul class="tabs" data-persist="true">
            <li><a href="#view1">Add Service</a></li>
            ...
            <form action="AddService" method="post">
                 <table>
                    <tr>
                        ...
                        <td><b>Request Mode</td>
                        <td><b>Issue</td>
                        <td><b>Remarks</b></td>
                        <td><b>Status</b></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="from" required style="width:170px"></td>
                        <td><select name="servicetype" style="width:170px">
                                <option value="Warranty">Warranty</option>
                                <option value="Chargeable">Chargeable</option>
                            </select></td>
                        <td><select name="requestmode" style="width:170px">
                                <option value="Call">Call</option>
                                
                                <option value="Mail">Mail</option><option value="Visitor">Visitor</option>
                        </select></td>
                        <td><input type="text" name="issue" required style="width:170px"></td>
                        <td><input type="text" name="remarks"  style="width:170px"></td>
                        <td>
                ...
                <hr/>
                <br><b>View Service Details:</b><br><br>
                 <form action="DispService.jsp">
                ...
                <br>
                <br>
                <b>Edit Service Details:</b><br><br>
                <form action="EditService.jsp">
                    Enter ID: <input type="text" name="id">&nbsp;&nbsp;&nbsp;
                    <input type="submit" value="Update Service">
                </form><br>
                <form action="AddServiceResponse.jsp">
                    Enter ID: <input type="text" name="id">&nbsp;&nbsp;&nbsp;
                ...
                <div id="printservice">
                <br><b>Service Details:&nbsp;&nbsp;<%=fmt.format(dt)%></b><br><br>
                <table>
                    <tr>
                    ...
                    <%
                    query="select * from services where Date='"+df.format(dt)+"' order by RequestTime desc";
                    System.out.println(query);
