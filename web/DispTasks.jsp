<%-- 
    Document   : DispTasks
    Created on : 24 Jun, 2015, 10:21:01 AM
    Author     : Rachna
--%>
...
<html>
    ...
    <body>
        ...
        <div id="printtask">
        <br><b>Tasks Details:&nbsp; &nbsp; &nbsp;<%=df.format(frm)%> to <%=df.format(t)%><br><br></b>
        ...
        <table>
            ...
            <% while(fromDate.compareTo(toDate)<=0){
                    %>&nbsp;&nbsp;
                    <%
                   String query="select DATE_FORMAT(Date,'%b %d') as Date,Time,ID,Task,Remarks,Priority,"+
                           "Status,FollowUp from tasksheet where UserId='"+id+"' and Date='"+fromDate+"' order by "+
                            "Priority='High' desc, Priority='Medium' desc, Priority='Low' desc, Status='Incomplete' desc, "+
                            "Status='In Progress' desc, Status='Completed' desc,Date desc, Time desc" ;
