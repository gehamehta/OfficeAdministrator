<%-- 
    Document   : DispVisitors
    Created on : 22 Jun, 2015, 10:02:48 PM
    Author     : Rachna
--%>
...
<html>
    ...
    <body>
       ...
       <input type="image" src="images/print.jpg" alt="Print" style="margin-left: 95%"
        ...
        <br><b>Visitors Details:&nbsp; &nbsp; &nbsp;<%=df.format(frm)%> to <%=df.format(t)%><br><br></b>
        ...
        <table>
            ...
            <% while(fromDate.compareTo(toDate)<=0){
                    %>&nbsp;&nbsp;
                    <%
                   String query="select DATE_FORMAT(Date,'%b %d') as Date,Time,ID,Name,Purpose,EnquiryMsg,HandledBy,Remarks,Status from visitors where Date='"+fromDate+"' order by date asc,time asc " ;
